		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SupplierList",
									"targetURL": "#tutsupplierx-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tutsupplierx-display": {
								"semanticObject": "tutsupplierx",
								"action": "display",
								"description": "Supplier list of ",
								"title": "SupplierList",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tut.supplierx",
									"url": sap.ui.require.toUrl("tut/supplierx")
								}
							}
						}
					}
